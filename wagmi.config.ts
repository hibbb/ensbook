...
const { MAINNET_CONTRACTS } = await import("./src/config/contracts");
...
export default defineConfig({
  ...
  contracts: [
    ...
    },
    {
      ...
      address: { 1: MAINNET_CONTRACTS.ETH_CONTROLLER_V3 },
    },
    {
      name: "BulkRenewal",
      abi: (await import("./src/abis/BulkRenewal.json")).default,
      address: { 1: MAINNET_CONTRACTS.BULK_RENEWAL },
    },
    // --- Chainlink 价格喂价 ---
    {
      name: "EthPriceFeed",
      abi: (await import("./src/abis/EthPriceFeed.json")).default,
      address: { 1: MAINNET_CONTRACTS.ETH_PRICE_FEED },
    },
  ],
