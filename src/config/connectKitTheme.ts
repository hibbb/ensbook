export const connectKitTheme = {
  ...
  "--ck-connectbutton-color": "#0dcaf0",
  "--ck-connectbutton-background": "#eee",
  "--ck-connectbutton-background-secondary": "#FFFFFF",
  "--ck-connectbutton-border-radius": "16px",
  "--ck-connectbutton-box-shadow": "0px 0px 0px 0px #ddd",
  "--ck-connectbutton-hover-color": "#0aa2c0",
  "--ck-connectbutton-hover-background": "#e5e5e5",
  "--ck-connectbutton-hover-box-shadow": "0px 0px 0px 0px #ddd",
  "--ck-connectbutton-active-color": "#0aa2c0",
  "--ck-connectbutton-active-background": "#e5e5e5",
  "--ck-connectbutton-active-box-shadow": "0px 0px 0px 0px #ddd",
  ...
  "--ck-secondary-button-color": "#483c32",
  ...
  "--ck-tertiary-button-color": "#483c32",
  ...
  "--ck-qr-dot-color": "#483c32",
  "--ck-qr-background": "#ffffff",
  "--ck-qr-border-color": "#f7f6f8",
  "--ck-focus-color": "#0aa2c0",
  "--ck-spinner-color": "#0dcaf0",
  "--ck-copytoclipboard-stroke": "#CCCCCC",
  "--ck-recent-badge-color": "#483c32",
