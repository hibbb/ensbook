...
class ConfigureForm extends React.Component {
  ...
  premiumPriceArray = [
    ...
    390577, 195264, 97608, 48780, 24366, 12159, 6055, 3004, 1478, 715, 333, 143,
    47, 0,
  ];
  ...
  submitForm = () => {
    ...
    confInfo.custom.register.registerWithConfig = Boolean(
      this.state.regRegisterWithConfig
    );
      ...
      <div className="ps-2 pe-3 d-inline-block text-start">
        ...
        >
          <button
            ...
            data-bs-target="#configureContainer"
            aria-controls="configureContainer"
          >
        ...
        <div
          ...
          aria-labelledby="configureContainerLabel"
        >
          ...
          <div className="offcanvas-body">
            <form>
              ...
              <InputGroup
                ...
                data-bs-target="#lookupCheckField"
                aria-expanded="false"
