    ...
    <div className="row">
      <div className="footnode-left align-self-center col-6">
        <div className="footnotes px-2">
          <a href="https://twitter.com/forlbb" target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faTwitter} /></a>
        </div>
      </div>
      <div className="footnode-right align-self-center col-6">
        <div className="footnotes px-2">
          ...
          <a href={getConf().repository} target="_blank" rel="noreferrer"><FontAwesomeIcon icon={faGithub} /></a>
        </div>
      </div>
    </div>
  )
